		                            ...
		                            <div class="card shadow mb-4">
		                                ...
		                                <div class="card-body">
										 ...
										 <table class="table table-bordered"  width="100%" cellspacing="0">
										    ...
										    <tr>
										    <th>Profile Registration Date</th> 
...
endwhile;
  ?>
       ...
       <p id='reportfile'> Report <span style="color:red; font-size:12px;">(PDF format allowed only)</span>    <input type="file" name="report" id="report"></p>
       <p>
<textarea name="remark" class="form-control" required="true" placeholder="Comments (Max 500 Characters)" maxlength="500" rows="5"></textarea>  </p> 
  <p>
