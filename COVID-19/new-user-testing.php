...
$query="insert into tblpatients(FullName,MobileNumber,DateOfBirth,GovtIssuedId,FullAddress,State) values('$fname','$mnumber','$dob','$govtid','$address','$state');";
...
<body id="page-top">
                      ...
                      <form name="newtesting" method="post">
                        ...
                        <div class="form-group">
                            <label>Full Name</label>
                                  ...
                                  <input type="text" class="form-control" id="mobilenumber" name="mobilenumber" placeholder="Enter your mobile number" pattern="[0-9]{11}" title="11 numeric characters only" required="true" onBlur="mobileAvailability()">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="govtissuedid" name="govtissuedid" placeholder="Enter your Voter ID number" required="true">
                                        </div>
                               <div class="form-group">
                                              <label>Address</label>
 ...
 <div class="form-group">
                                              <label>City</label>
                                      <input type="text" class="form-control" id="state" name="state" placeholder="Enter your City" required="true">
                                        </div>
